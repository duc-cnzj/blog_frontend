<template>
    <div>
                        ...
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            ...
                            <nav class="main_nav">
                                <ul>
                                    <li v-for="(l, i) in links" :key="i">
                                        <router-link :to="l.link" exact>{{ l.title }}</router-link>
                                    </li>
                                </ul>
                            </nav>
                            <div class="search_container ml-auto">
                                <div class="weather">
                                    ...
                                    <form action="#">
                                        <input type="search" class="header_search_input" required="required" placeholder="搜索文章....😄" />
        ...
        <div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400" :class="menuActiveClass">
            ...
            <nav class="menu_nav">
                <ul class="menu_mm">
                    <li v-for="(l, i) in links" :key="i" class="menu_mm">
                        <router-link :to="l.link" exact>{{ l.title }}</router-link>
                    </li>
                </ul>
            </nav>
